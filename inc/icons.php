...
if (!function_exists('velocitychild_get_bootstrap_icon_svg')) {
    ...
    function velocitychild_get_bootstrap_icon_svg($icon, $class = '')
    {
        $icons = array(
            ...
            'clock' => '<path d="M8 3.5a.5.5 0 0 1 .5.5v3.707l2.146 2.147a.5.5 0 0 1-.708.707l-2.292-2.293A.5.5 0 0 1 7.5 8V4a.5.5 0 0 1 .5-.5"/><path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m0-1A7 7 0 1 1 8 1a7 7 0 0 1 0 14"/>',
        );
